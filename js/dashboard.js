$(function(){
  ...
  var piedata = [
    { label: "Digital Mktg", data: [[1,30]], color: '#ff9800'},
    { label: "IT Sol.", data: [[1,70]], color: '#455a64'},
    { label: "Web Des & Dev", data: [[1,90]], color: '#ff6f00'},
    { label: "Virtual Staff", data: [[1,80]], color: '#324463'}
  ];
